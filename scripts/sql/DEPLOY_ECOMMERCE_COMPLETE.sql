-- ==============================================================================
-- COMPLETE E-COMMERCE DEPLOYMENT SCRIPT
-- ==============================================================================
-- This script deploys the entire e-commerce platform in one go:
-- 1. Creates all tables with RLS
-- 2. Creates all functions
-- 3. Inserts 6 categories
-- 4. Inserts 63 sample products
-- ==============================================================================
...
-- Shopping Orders Table (Enhanced)
...
-- Affiliate Applications: Users can view/create own, admins can manage all
...
-- Affiliate Links: Users can view own, admins can view all
...
-- Affiliate Clicks: No direct access (managed by functions)
DROP POLICY IF EXISTS "No direct access to clicks" ON public.affiliate_clicks;
CREATE POLICY "No direct access to clicks" ON public.affiliate_clicks FOR SELECT USING (false);

-- Shopping Orders: Users can view own, admins can view all
...
-- ==============================================================================
-- PART 8: INSERT SAMPLE PRODUCTS
-- ==============================================================================
-- Note: This is a condensed version. For full 63 products, run the separate files.
-- ==============================================================================
...
BEGIN
    ...
    -- Sample products (10 featured items)
    ...
    (cat_beauty, 'Lakme Absolute Skin Natural Mousse Foundation', 'lakme-mousse-foundation',
    ...
    (cat_sports, 'Strauss Yoga Mat 6mm with Bag', 'strauss-yoga-mat-6mm',
    ...
    (cat_books, 'Atomic Habits by James Clear', 'atomic-habits-book',
...
-- ==============================================================================
-- Next steps:
-- 1. Verify tables: SELECT COUNT(*) FROM products;
-- 2. Regenerate TypeScript types in your project
