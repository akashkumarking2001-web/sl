  ...
  const navItems: NavItem[] = [
    { id: "dashboard", label: "Dashboard", icon: LayoutDashboard },
    {
      ...
      children: [
        ...
        { id: "course-only-students", label: "Course-Only Students", icon: GraduationCap },
        { id: "combo-plan-students", label: "Combo Plan Students", icon: Shield },
      ],
    },
    {
      id: "requests-section",
      ...
      children: [
        ...
        { id: "affiliate-requests", label: "Affiliate Requests", icon: Users, badge: pendingCounts.affiliateRequests },
      ],
    },
    {
      id: "income-section",
    ...
    { id: "packages-manager", label: "Packages", icon: Package },
    { id: "courses", label: "Courses", icon: BookOpen },
    {
      ...
      children: [
        ...
        { id: "store-manager", label: "Store Appearance", icon: LayoutGrid }, // Added
        { id: "shopping-orders", label: "Manage Orders", icon: Truck, badge: pendingCounts.shoppingOrders },
      ],
    },
