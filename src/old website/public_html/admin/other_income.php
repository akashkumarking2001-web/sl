                    ...
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            ...
                            <table class="table table-borderless datatable">
                                ...
                                <tbody>
                                    <?php
                                    $direct_agent_list_query = mysqli_query($conn, "SELECT * FROM `wallet_history` WHERE `desp`!='Level Income' AND `desp`!='Global Income' AND `desp`!='Wallet Recharge' AND `desp`!='Referral Income' AND `status`='0' ORDER BY `wallet_history`.`date_time` DESC");
                                    $a = 0;
