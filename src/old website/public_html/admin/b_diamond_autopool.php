        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">B-Diamond Autopool List</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            <h5 class="card-title">B-Diamond Autopool List</h5>
                            ...
                            <table class="table table-borderless datatable">
                                ...
                                <tbody>
                                    <?php
                                    $autopool = mysqli_query($conn, "SELECT * FROM `b_diamond`");
                                    $a = 0;
