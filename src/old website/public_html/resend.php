                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Resend Mail</h5>
                                        <p class="text-center small">Enter your Mail ID</p>
                                    </div>
                                    ...
                                    <form class="row g-3 needs-validation" action="request_handler.php" method="post" novalidate>
                                        ...
                                        <div class="col-12">
                                            <button class="btn btn-primary w-100" name="resend" type="submit">Resend</button>
                                        </div>
                                        <div class="col-12">
