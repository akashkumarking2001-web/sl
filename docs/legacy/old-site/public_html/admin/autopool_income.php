        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Global Income</li>
                </ol>
            </nav>
        </div>
        ...
        <section class="section dashboard">
            ...
            <div class="col-lg-12">
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            <h5 class="card-title">Global Income</h5>
                            ...
                            <table class="table table-borderless datatable">
                                ...
                                <tbody>
                                    <?php
                                    $direct_agent_list_query = mysqli_query($conn, "SELECT * FROM `wallet_history` WHERE `desp`='Global Income' ORDER BY `wallet_history`.`date_time` DESC");
                                    $a = 0;
