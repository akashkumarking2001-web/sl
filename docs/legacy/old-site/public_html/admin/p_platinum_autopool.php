        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">P-Platinum Autopool List</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            <h5 class="card-title">P-Platinum Autopool List</h5>
                            ...
                            <table class="table table-borderless datatable">
                                ...
                                <tbody>
                                    <?php
                                    $autopool = mysqli_query($conn, "SELECT * FROM `p_platinum`");
                                    $a = 0;
