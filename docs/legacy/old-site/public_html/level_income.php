                    ...
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $direct_agent_list_query = mysqli_query($conn, "SELECT * FROM `wallet_history` WHERE `agent_id`= '$my_id' AND `desp`='Level Income' ORDER BY `wallet_history`.`date_time` DESC");
                                    $a = 0;
